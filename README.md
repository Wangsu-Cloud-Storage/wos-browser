...
* [windows-x64-适用专有云的版本](http://wcsd.chinanetcenter.com/tool/wos-browser-1.1.3-pc-win32-x64.zip)
* [mac-x64-适用专有云的版本](http://wcsd.chinanetcenter.com/tool/wos-browser-1.1.3-pc-darwin-x64.zip)
...
|  版本   | 变更内容  |
|  ----  | ----  |
| 专有云版本 | 1、支持创建空间 2、支持使用ip作为endpoint 3、支持多版本管理|
