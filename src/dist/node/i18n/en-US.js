module.exports = {
  ...
  'auth.presetWosPath': 'Preset WOS Path',
  'auth.presetWosPath.placeholder': 'Optional, format: wos://bucket/key/',
  'auth.regionName.placeholder': 'RegionName',
  ...
  'auth.eptpl.popup.msg2': 'Please enter a custom Endpoint, such as:',

  'auth.presetWosPath.popup.msg1': 'The current AK that has all Bucket rights does not need to set the "Preset WOS Path"',
  'auth.presetWosPath.popup.msg2': 'The current AK only has the permissions of a Bucket or a certain path under a Bucket, you need to set the "Preset WOS Path"',
  ...
  'genAuthToken.message5': 'Log in to the WOS browser using the generated authorization code above, You can get {{privilege}} permission to access this {{type}} [{{object}}], Valid until {{expiration}}.',
  ...
  'file.download.warning': 'If you have enabled the Referer whitelist for WOS Buckets and the Referer field cannot be left empty, you will not be able to access this URL directly through a browser.',
  ...
  'grant.email.title': 'WOS Browser Authorization',
  'grant.email.body.title': 'WOS Browser currently supports 2 ways to login, you can choose any one:',

  'goto.create.role': 'Go to create a role',

    'files.regex.search': 'Resource Search',
    'search': 'Search',
    'file.name': 'Name',
    'file.size': 'Size',
