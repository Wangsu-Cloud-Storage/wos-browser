module.exports = {
  ...
  'auth.presetWosPath': '预设WOS路径',
  'auth.presetWosPath.placeholder': '可选,格式如: wos://bucket/key/',
  'auth.regionName.placeholder': '请输入RegionName',
  ...
  'auth.eptpl.popup.msg2': '请输入自定义Endpoint，如:',

  'auth.presetWosPath.popup.msg1': '大权限子账号登录: 当前使用的AK已拥有所有Bucket的权限，不需要设置"预设WOS路径"',
  'auth.presetWosPath.popup.msg2': '小权限子账号登录: 当前使用的AK只有某个Bucket或者Bucket下某个路径的权限，需要设置"预设WOS路径"',

  'auth.remember.popup.msg1': '勾选"记住秘钥"可保存AK秘钥，再次登录时，单击AK历史，可选择该秘钥登录，不需要手动输入AK。请不要在临时使用的电脑上勾选！',
  ...
  'genAuthToken.message5': '使用上面生成的授权码登录WOS浏览器，可以达到只拥有[{{object}}]这个{{type}}的{{privilege}}权限的效果,有效期至{{expiration}}。',
  ...
  'grant.email.title': 'WOS Browser 授权',
  'grant.email.body.title': 'WOS Browser 目前支持2种方式登录, 您可以选择任意一种:',

  'goto.create.role': '去创建角色',
    'files.regex.search': '资源搜索',
    'search': '搜索',
    'file.name': '文件名',
    'file.size': '大小',
    'update.time': '修改时间',
