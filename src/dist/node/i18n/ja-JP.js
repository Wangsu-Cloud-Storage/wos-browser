module.exports = {
  ...
  'auth.presetWosPath': 'プリセット WOS パス',
  'auth.presetWosPath.placeholder': 'オプション, 形式: wos://bucket/key/',
  ...
  'auth.eptpl.popup.msg2': 'ようなカスタムエンドポイントを入力してください:',

  'auth.presetWosPath.popup.msg1': '現在使用されている AK には、すべてのバケットのアクセス権があるので、[プリセット WOS パス] を設定する必要はありません。',
  'auth.presetWosPath.popup.msg2': '現在使用されている AK は、特定バケットまたはバケット配下の特定パスに対するアクセス権しかないので、[プリセット WOS パス] を設定する必要があります',
  ...
  'genAuthToken.message5': '上に生成された認証コードを使用して WOS ブラウザにログインすると、{{type}} [{{object}}] にアクセスする権限を得ることができます。{{expiration}} まで有効です。',
  ...
  'file.download.warning': 'WOS バケットのリファラリストを設定する際、ノーリファラを選択しなかった場合、ブラウザから直接 URL にアクセスすることはできません。',
  ...
  'grant.email.title': 'WOSブラウザ認証',
  'grant.email.body.title': 'WOS ブラウザは現在 2 つのログイン方法をサポートしています。いずれかを選択できます:',
