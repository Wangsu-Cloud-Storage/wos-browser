angular.module('web')
  .factory('wosUploadManager', ['$q', '$state', '$timeout', 'wos', 'AuthInfo', 'Toast', 'Const', 'DelayDone', 'safeApply', 'settingsSvs',
    function ($q, $state, $timeout, wos, AuthInfo, Toast, Const, DelayDone, safeApply, settingsSvs) {
