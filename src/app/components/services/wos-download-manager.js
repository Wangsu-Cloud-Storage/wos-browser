angular.module('web')
  .factory('wosDownloadManager', ['$q', '$state', '$timeout', 'AuthInfo', 'wos', 'Toast', 'Const', 'DelayDone', 'safeApply', 'settingsSvs',
    function ($q, $state, $timeout, AuthInfo, wos, Toast, Const, DelayDone, safeApply, settingsSvs) {
      ...
      function createDownloadJobs(fromWosInfos, toLocalPath, jobsAddedFn) {
        ...
        loop(fromWosInfos, function (jobs) {
