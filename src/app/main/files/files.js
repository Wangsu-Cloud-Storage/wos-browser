angular.module('web')
  .controller('filesCtrl', ['$scope', '$rootScope', '$uibModal', '$timeout','$translate', 'AuthInfo', 'wos', 'settingsSvs', 'fileSvs', 'safeApply', 'Toast', 'Dialog','$location',
    function ($scope, $rootScope, $modal, $timeout, $translate, AuthInfo, wos, settingsSvs, fileSvs, safeApply, Toast, Dialog,$location) {
