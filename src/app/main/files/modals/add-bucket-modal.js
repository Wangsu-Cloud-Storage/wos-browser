angular.module('web')
  .controller('addBucketModalCtrl', ['$scope', '$uibModalInstance', '$translate', 'callback', 'wos', 'Const', 'Toast',
    function ($scope, $modalInstance, $translate, callback, wos, Const, Toast) {
