angular.module('web')
  .controller('getAddressModalCtrl', ['$scope', '$q', '$translate', '$uibModalInstance', 'item', 'currentInfo', 'wos', 'safeApply', 'Const', 'Mailer', 'Toast',
    function ($scope, $q, $translate, $modalInstance, item, currentInfo, wos, safeApply, Const, Mailer, Toast) {
