angular.module('web')
  .controller('grantModalCtrl', ['$scope', '$q', '$uibModalInstance','$translate', 'items', 'currentInfo','ramSvs','wos','settingsSvs','subUserAKSvs','Mailer','Const','Toast','AuthInfo', 'safeApply',
    function ($scope, $q, $modalInstance, $translate, items, currentInfo,ramSvs, wos, settingsSvs, subUserAKSvs, Mailer, Const, Toast, AuthInfo, safeApply) {
        ...
        angular.forEach($scope.items, function (item) {
          if (item.region || item.isFolder) {
            ...
            t.push({
              ...
              "Action": actions,
              "Resource": [
                "acs:wos:*:*:" + currentInfo.bucket + '/' + item.path
              ]
            });
          }
        });
