angular.module('web')
  .controller('bucketMultipartModalCtrl', ['$scope','$q','$uibModalInstance','$translate','Dialog','bucketInfo','Toast','wos','safeApply',
    function ($scope, $q, $modalInstance, $translate, Dialog, bucketInfo,Toast, wos,safeApply) {
      ...
      function showDelete(items){
        ...
        Dialog.confirm( title, message, function(b){
          if(b){
            ...
            wos.abortAllUploads(bucketInfo.region, bucketInfo.name, items)
            .then(function(){
