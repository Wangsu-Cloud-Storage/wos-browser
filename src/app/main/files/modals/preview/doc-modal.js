angular.module('web')
  .controller('docModalCtrl', ['$scope','$uibModalInstance','Const','bucketInfo','objectInfo', 'showFn', 'wos','fileType',
    function ($scope, $modalInstance, Const, bucketInfo, objectInfo, showFn, wos, fileType) {
