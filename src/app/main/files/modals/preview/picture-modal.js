angular.module('web')
  .controller('pictureModalCtrl', ['$scope', '$uibModalInstance', '$timeout', '$uibModal', 'wos', 'safeApply', 'showFn', 'bucketInfo', 'objectInfo','AuthInfo', 'fileType',
    function ($scope, $modalInstance, $timeout, $modal, wos, safeApply, showFn, bucketInfo, objectInfo, AuthInfo, fileType) {
