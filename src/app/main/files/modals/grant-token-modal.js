angular.module('web')
  .controller('grantTokenModalCtrl', ['$scope', '$q', '$uibModalInstance','$translate', 'item', 'currentInfo','ramSvs','wos','AuthInfo','stsSvs','Toast', 'safeApply',
    function ($scope, $q, $modalInstance, $translate, item, currentInfo, ramSvs, wos, AuthInfo, stsSvs, Toast, safeApply) {
