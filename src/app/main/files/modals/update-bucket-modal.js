angular.module('web')
  .controller('updateBucketModalCtrl', ['$scope','$uibModalInstance','$translate', 'item','callback','wos','safeApply','Const',
    function ($scope, $modalInstance, $translate, item, callback, wos, safeApply, Const) {
