...
angular.module('web')
  .controller('transferDownloadsCtrl', ['$scope', '$timeout','$translate', '$interval', 'jobUtil', 'wosDownloadManager', 'DelayDone', 'Toast', 'Dialog', 'safeApply',
    function ($scope, $timeout, $translate, $interval, jobUtil, wosDownloadManager, DelayDone, Toast, Dialog, safeApply) {
