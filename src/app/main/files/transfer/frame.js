...
angular.module('web')
.controller('transferFrameCtrl', ['$scope', '$translate','wosUploadManager','wosDownloadManager','Toast','safeApply',
function($scope ,$translate,wosUploadManager,wosDownloadManager, Toast, safeApply){
