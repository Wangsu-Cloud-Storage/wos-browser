...
angular.module('web')
  .controller('transferUploadsCtrl', ['$scope', '$timeout','$translate', '$interval','jobUtil', 'DelayDone', 'wosUploadManager', 'Toast','Dialog',
    function ($scope, $timeout, $translate, $interval, jobUtil, DelayDone, wosUploadManager, Toast, Dialog) {
