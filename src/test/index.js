...
function getAppPath(){
  ...
  switch(key){
    case 'darwin-x64': return 'build/wos-browser-darwin-x64/wos-browser.app/Contents/MacOS/wos-browser';
    case 'linux-x64': return 'build/wos-browser-linux-x64/wos-browser';
    case 'win32-x64': return 'build/wos-browser-win32-x64/wos-browser.exe';
  }
}
